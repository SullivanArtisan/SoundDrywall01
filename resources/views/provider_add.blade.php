            ...
            <div class="col">
                <form method="post" action="{{route('op_result.provider_add')}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col"><input class="form-control mt-1 my-text-height" type="text" id="pvdr_city" name="pvdr_city"></div>
                        <div class="col"><label class="col-form-label">Province:&nbsp;</label></div>
                        <div class="col"><input class="form-control mt-1 my-text-height" type="text" id="pvdr_province" name="pvdr_province"></div>
                    </div>
                    <div class="row">
                        <div class="col"><label class="col-form-label">Post Code:&nbsp;</label></div>
                        <div class="col"><input class="form-control mt-1 my-text-height" type="text" id="pvdr_postcode" name="pvdr_postcode"></div>
                        <div class="col"><label class="col-form-label">Country:&nbsp;</label></div>
                        <div class="col"><input class="form-control mt-1 my-text-height" type="text" id="pvdr_country" name="pvdr_country"></div>
                    </div>
                    <div class="row">
                        <div class="col"><label class="col-form-label">Contact:&nbsp;</label></div>
                        <div class="col"><input class="form-control mt-1 my-text-height" type="text" id="pvdr_contact" name="pvdr_contact"></div>
                        <div class="col"><label class="col-form-label">Phone:&nbsp;</label></div>
                        <div class="col"><input class="form-control mt-1 my-text-height" type="text" id="pvdr_phone" name="pvdr_phone"></div>
                    </div>
                    <div class="row">
                        <div class="col"><label class="col-form-label">Email:&nbsp;</label></div>
                        <div class="col"><input class="form-control mt-1 my-text-height" type="text" id="pvdr_email" name="pvdr_email"></div>
                        <div class="col"><label class="col-form-label">&nbsp;</label></div>
                        <div class="col"><input class="form-control mt-1 my-text-height" type="hidden" id="id" name="id"></div>
                    </div>
                    <div class="row my-3">
                        <div class="w-25"></div>
                        <div class="col">
