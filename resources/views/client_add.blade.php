...
@section('function_page')
	...
	?>
	<div>
		<h2 class="text-muted pl-2 mb-2">Add a New Client</h2>
	</div>
    <div>
		@if ($errors->any())
            ...
            <div class="col">
                <form method="post" action="{{route('op_result.client_add')}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col"><input class="form-control mt-1 my-text-height" type="text" id="clnt_postcode" name="clnt_postcode"></div>
                        <div class="col"><label class="col-form-label">Country:&nbsp;</label></div>
                        <div class="col"><input class="form-control mt-1 my-text-height" type="text" id="clnt_country" name="clnt_country"></div>
                    </div>
                    <div class="row">
                        <div class="col"><label class="col-form-label">Contact:&nbsp;</label></div>
                        <div class="col"><input class="form-control mt-1 my-text-height" type="text" id="clnt_contact" name="clnt_contact"></div>
                        <div class="col"><label class="col-form-label">Phone:&nbsp;</label></div>
                        <div class="col"><input class="form-control mt-1 my-text-height" type="text" id="clnt_phone" name="clnt_phone"></div>
                    </div>
                    <div class="row">
                        <div class="col"><label class="col-form-label">Email:&nbsp;</label></div>
                        <div class="col"><input class="form-control mt-1 my-text-height" type="text" id="clnt_email" name="clnt_email"></div>
